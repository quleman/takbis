...
class TapuAnalyzerGUI(QMainWindow):
    ...
    def open_help_file(self):
        # Create a dialog for the help content
        help_dialog = QDialog(self)
        help_dialog.setWindowTitle("Takbis Belgeleri İşleme / Analiz / Raporlama Yardım")
        help_dialog.setMinimumSize(800, 600)
    
        # Main layout
        layout = QVBoxLayout(help_dialog)
    
        # Create a text browser to display formatted help content
        help_text = QTextEdit()
        help_text.setReadOnly(True)
    
        # Define the help content in HTML format
        help_content = """
        <h1>Takbis Belgeleri İşleme / Analiz / Raporlama Yardım</h1>
    
        <h2>Genel Bilgiler</h2>
        <p>Bu uygulama, tapu kayıt belgelerini (Takbis) işlemek, analiz etmek ve raporlamak için tasarlanmıştır.</p>
    
        <h2>Temel Fonksiyonlar</h2>
        <ul>
            <li><b>🔰 Takbisleri Seç:</b> Analiz edilecek PDF formatındaki tapu belgelerini seçmenizi sağlar.</li>
            <li><b>🟥 İçeri Aktar:</b> Seçilen belgeleri işleyerek veritabanına kaydeder.</li>
            <li><b>📑 Çoklu Raporla:</b> Tüm taşınmazları toplu olarak raporlar.</li>
            <li><b>📄 Tekli Raporla:</b> Seçilen taşınmaz için detaylı rapor oluşturur.</li>
            <li><b>🧹 Temizle:</b> Veritabanındaki tüm kayıtları siler.</li>
            <li><b>💾 TXT Kaydet:</b> Oluşturulan raporu metin dosyası olarak kaydeder.</li>
            <li><b>📊 Hisse Tablosu:</b> Taşınmaz hisse dağılımını Excel formatında dışa aktarır.</li>
        </ul>
    
        <h2>Kullanım Adımları</h2>
        <ol>
            <li>Sol panelden <b>🔰 Takbisleri Seç</b> butonuna tıklayarak PDF belgelerini seçin.</li>
            <li><b>🟥 İçeri Aktar</b> butonuyla belgeleri işleyin.</li>
            <li>İşlenen belgeler, orta paneldeki ağaç görünümünde listelenecektir.</li>
            <li>Herhangi bir taşınmaza çift tıklayarak detaylarını görüntüleyebilirsiniz.</li>
            <li>Taşınmaza sağ tıklayarak daha fazla işlem seçeneğine erişebilirsiniz.</li>
            <li><b>📄 Tekli Raporla</b> veya <b>📑 Çoklu Raporla</b> butonlarıyla raporlar oluşturabilirsiniz.</li>
            <li>Oluşturulan raporları <b>💾 TXT Kaydet</b> butonuyla kaydedebilirsiniz.</li>
        </ol>
    
        <h2>Hızlı İpuçları</h2>
        <ul>
            <li>Ağaç görünümünde bir taşınmaza sağ tıklayarak hızlı işlemler menüsüne erişebilirsiniz.</li>
            <li>Bir taşınmaza çift tıklayarak özet bilgileri görüntüleyebilirsiniz.</li>
            <li>Hisse dağılımını Excel formatında görüntülemek için <b>📊 Hisse Tablosu</b> butonunu kullanabilirsiniz.</li>
            <li>Tüm taşınmazları içeren toplu bir rapor oluşturmak için <b>📑 Çoklu Raporla</b> butonunu kullanabilirsiniz.</li>
        </ul>
    
        <h2>Taşınmaz Türleri</h2>
        <p>Program iki tür taşınmazı işleyebilir:</p>
        <ul>
            <li><b>Ana Taşınmazlar:</b> Arsa, tarla gibi taşınmazlar</li>
            <li><b>Bağımsız Bölümlü Taşınmazlar:</b> Daire, dükkân gibi kat mülkiyeti veya kat irtifakına konu taşınmazlar</li>
        </ul>
    
        <h2>Teknik Bilgiler</h2>
        <p>Program, PDF belgelerinden veri çıkarma, veritabanı yönetimi ve rapor oluşturma işlevlerini otomatik olarak gerçekleştirir. 
        SQLite veritabanı kullanılmaktadır ve tüm veriler yerel olarak saklanmaktadır. </p>
        

        Önerileriniz İçin: anufuk@gmail.com
        """
    ...
    def export_to_excel(self, tasinmaz_kimlik=None):     
        try:
            ...
            try:
                ...
                logging.error(f"Masaüstü yolu alma hatası: {str(e)}")
                default_save_path = default_filename

            file_path, _ = QFileDialog.getSaveFileName(
                self, "Excel Dosyasını Kaydet", default_save_path, 
